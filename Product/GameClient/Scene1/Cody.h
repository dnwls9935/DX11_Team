...
class Cody final : public Actor
{
public:			Cody(bool bOperationPad) noexcept;
public:	virtual ~Cody(void) noexcept;
...
public:		virtual void		Interaction(void) noexcept override;
public:		virtual void		Crouch(void) noexcept;
...
private:	HierarcyNode*	_leftHandBone;
...
private:	TargetUI*		_mayTarget;

	   /* Test Code */

private:	float			_lerpTime;
private:	bool			_wareHouseNarrative;
